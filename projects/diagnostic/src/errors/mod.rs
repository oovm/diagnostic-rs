...
/// A minimal interface for accessing source errors when rendering diagnostics.
///
...
pub trait Files<'a> {
    /// A unique identifier for errors in the file provider. This will be used
    /// for rendering `diagnostic::Label`s in the corresponding source errors.
    ...
    fn name(&'a self, id: Self::FileId) -> Result<Self::Name, DiagnosticError>;

    /// The source code of a file.
    fn source(&'a self, id: Self::FileId) -> Result<Self::Source, DiagnosticError>;
    ...
    /// [`errors`]: crate::errors
    fn line_index(&'a self, id: Self::FileId, byte_index: usize) -> Result<usize, DiagnosticError>;
    ...
    fn line_number(&'a self, id: Self::FileId, line_index: usize) -> Result<usize, DiagnosticError> {
        Ok(line_index + 1)
    }
    ...
    fn location(&'a self, id: Self::FileId, byte_index: usize) -> Result<Location, DiagnosticError> {
    ...
    fn line_range(&'a self, id: Self::FileId, line_index: usize) -> Result<Range<usize>, DiagnosticError>;
}
