...
impl<'writer, 'config> Renderer<'writer, 'config> {
    ...
    /// Empty line.
    pub fn render_empty(&mut self) -> Result<(), DiagnosticError> {
        writeln!(self)?;
        Ok(())
    }
    ...
    /// Location focus.
    fn snippet_locus(&mut self, locus: &Locus) -> Result<(), DiagnosticError> {
        write!(
            self,
    ...
    fn outer_gutter(&mut self, outer_padding: usize) -> Result<(), DiagnosticError> {
    ...
    fn border_left(&mut self) -> Result<(), DiagnosticError> {
        self.set_color(&self.styles().source_border)?;
    ...
    fn border_left_break(&mut self) -> Result<(), DiagnosticError> {
        self.set_color(&self.styles().source_border)?;
    ...
    fn inner_gutter_space(&mut self) -> Result<(), DiagnosticError> {
        write!(self, "  ")?;
        Ok(())
    }
